...
Tags: woocommerce, orders, fulfillment, warehouse, inventory management
Requires at least: 4.4
Tested up to: 6.6.2
Requires WooCommerce at least: 2.6.0
Tested WooCommerce up to: 9.3.1
Stable Tag: 1.0.4
License: GPLv3
...
6. **If you are using HPOS you will need to enable compatibility mode.**
 ...
 * Improvement - Updated plugin to use correct Webhook endpoint and use V3 of Infoplus API

= 2020-04-27 - version 1.0.3 =
 * Improvement - Able to specify an Order Source for the WooCommerce Store
