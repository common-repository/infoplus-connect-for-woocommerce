...
class WC_Infoplus_REST_Webhook {
	 ...
	 * @return array
	 */
	public function add_valid_event( array $events ): array
    {
	 ...
	 *@since 1.0.0
	 */
	public function add_topic_hook( array $topic_hooks ) : array
    {
	 ...
	 *@since 1.0.0
	 */
	public function disable_async_delivery( bool $async,  $webhook ) : bool
    {
	 ...
	 */
	public function adjust_payload( array $payload, string $resource, int $resource_id, int $webhook_id ) : array
    {
